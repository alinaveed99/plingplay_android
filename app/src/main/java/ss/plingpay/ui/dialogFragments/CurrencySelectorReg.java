...
/**
 * Created by samar_000 on 10/5/2016.
 */

public class CurrencySelectorReg  extends DialogFragment implements Listeners.CurrencyListener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        listerner = (RegistrationActivity)getActivity();
